---
name: surge
description: "Operate and troubleshoot Surge with surge-cli for runtime diagnostics, outbound mode, policy groups, DNS flush, profile reload, and controlled state changes."
metadata:
  version: "1"
---

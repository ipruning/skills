...
description: Start or continue a practical Web full-stack app, especially React dashboard, SaaS, internal tool, or product prototype work where the user needs a coherent stack choice, scaffold command, auth/data boundary, and first usable feature. Use for new Web app bootstraps, Better-T-Stack plus Convex starts, Convex-managed WorkOS AuthKit setup, Cloudflare Kumo UI starts, and early full-stack feature briefs. Do not use for React Native native apps, static marketing-only pages, or narrow edits inside an already established stack.
metadata:
  version: "1"
---
